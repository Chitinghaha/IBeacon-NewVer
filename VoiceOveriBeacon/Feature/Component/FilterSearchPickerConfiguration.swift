...
public struct AccessibilitySearchFilterPickerConfiguration: FilterSearchPickerConfiguration {
    var contentTextColor: UIColor = .label
    
    var contentTextFont: UIFont = UIFont.preferredFont(forTextStyle: .title1)
    
    var closeButtonTextColor: UIColor = .label
    
    var closeButtonFont: UIFont = UIFont.preferredFont(forTextStyle: .title1)
    
    var closeButtonText: String = "Close"
    
    var titleTextColor: UIColor = .label
    
    var titleFont: UIFont = UIFont.preferredFont(forTextStyle: .largeTitle)
    ...
    var searchBarFont: UIFont = UIFont.preferredFont(forTextStyle: .largeTitle)
